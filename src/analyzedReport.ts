...
/**
 * Analyzes the ESLint report of changed files in a pull request and generates a summary of the analysis.
 *
 * @async
 * @param {ESLintReport} reportJS - The ESLint report to analyze
 * @returns {Promise<AnalyzedESLintReport>} The analyzed ESLint report
 */
export async function getPullRequestChangedAnalyzedReport(reportJS: ESLintReport): Promise<AnalyzedESLintReport> {
  ...
  `;
    ...
    /**
     * Handles errors that occur during the analysis process.
     *
     * @param {Error} err - The error that occurred
     * @returns {AnalyzedESLintReport} The analyzed ESLint report
     */
